...
- Carrito de compras interactivo (con offcanvas)  
- Panel de administración para CRUD de productos y usuarios  
- Control de acceso por roles (cliente y administrador)  
- Diseño responsive con vistas personalizadas para escritorio y móvil  
- Gestión de productos eliminados (con campo `eliminado`)  
